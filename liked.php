...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            $stmt = $conn->prepare("SELECT products.* FROM liked_items INNER JOIN products ON liked_items.p_id = products.Pid WHERE products.deleted = 0 AND liked_items.c_id = ?");
            ...
            if (mysqli_num_rows($result) === 0) {
                echo "<p style='color:white;' >No products found in your Liked items.</p>";
            } else {
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="product-card">
                            <span class="close-btn" onclick="deleteFromliked(<?= $uid ?>, '<?= $productId ?>')"><i
                            ...
                            if (isset($_SESSION['username'])) {
                                echo "<a href='addtocart.php?pid=$productId' class='btn btn-primary'>Add to cart</a>";
                            } else {
    ...
    <script>
        function deleteFromliked(uid, pid) {
            if (confirm("Are you sure you want to remove this item from your cart?")) {
                window.location.href = "deletefromliked.php?uid=" + uid + "&pid=" + pid;
            }
        }
    </script>
